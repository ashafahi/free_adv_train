...
def get_args():
    ...
    parser.add("--data_path", "-d", type=str, default="data/cifar10", help="Path to load dataset, default=data/cifar10")
    ...
    parser.add("--out_steps", "-o", type=int, default=500, help="Number of output steps, default=500")
    ...
    parser.add("--momentum", "-m", type=float, default=0.9, help="The momentum parameter, default=0.9")
    parser.add("--std_rand", type=float, default=0.0, help="Standard rand variable, default=0.0")
    parser.add("--xent_clip", "-x", type=float, default=0.0, help="Cross-entropy clip, default=0.0")
    parser.add("--size_uniform", "-u", type=float, default=0.0, help="Size uniform value, default=0.0")
    parser.add("--label_smoothing", "-l", type=float, default=0.0, help="Label smoothing value, default=0.0")
    parser.add("--reset", "-r", type=bool, default=False, help="Set True to reset the purturbation after each iteration, default=False")
    parser.add("--steps_skip", "-s", type=int, default=4, help="Number of steps to repeat trainig on the same batch, default=4")
    ...
    parser.add("--pgd_steps", "-p", type=int, default=20, help="Number of steps to PGD attack, default=20")
    parser.add("--step_size", "-z", type=float, default=2.0, help="Step size in PGD attack for generating adversarial examples in each step, default=2.0")
    ...
    parser.add("--sotre_adv_path", type=str, default="attack.npy", help="Path to store the generated adversarial examples") 
